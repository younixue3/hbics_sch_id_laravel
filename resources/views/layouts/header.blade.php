    ...
    <div>
        <div
            ...
            <nav class="hidden md:flex space-x-10">
                <a href="index.html" id="nav1" class="text-lg py-5 text-white hover:text-gray-200" onclick="navBar()">
                    Home
                </a>
                <a href="#" id="nav4" class="text-lg py-5 text-white hover:text-gray-200" onclick="navBar()">
                    About
                </a>
