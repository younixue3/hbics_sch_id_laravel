...
@section('content')
    <div class="bg-pattern pt-72 pb-10 text-center">
        ...
        <div class="md:flex py-20 px-10 md:px-20">
            ...
            <div
                class="md:w-3/5 py-10 px-10 md:px-20 bg-white shadow-xl rounded-2xl w-full flex-row text-left text-sm md:text-base">
                <div class="my-2">
                ...
                <div class="my-2 grid grid-cols-2 gap-5">
                    <div>
                        ...
                        <select
                            class="bg-gray-100 resize-none w-full rounded-md py-2 pl-5 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 font-semibold">
