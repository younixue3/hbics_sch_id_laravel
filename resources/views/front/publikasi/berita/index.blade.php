        ...
        <div class="md:px-20 my-10">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                @forelse($berita as $key => $value)
                    @if($key % 2 != 0)
                        <a class="md:row-span-1 bg-white rounded-2xl p-2" href="{{route('berita.show', $value->randKey)}}">
                            @if($value->type === 'video')
                    ...
                    @else
                        <a class="md:row-span-2 bg-white rounded-2xl p-2" href="{{route('berita.show', $value->randKey)}}">
                            @if($value->type === 'video')
