        ...
        <div class="bg-pattern">
            <div class="p-20">
                <div class="grid grid-cols-2 gap-10">
                    <div class="bg-white rounded-3xl overflow-hidden transform hover:scale-105 transition-all ease-in-out duration-500">
                        <iframe class="w-full h-96" src="https://www.youtube.com/embed/__SIn1-nuUo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div class="bg-white rounded-3xl overflow-hidden transform hover:scale-105 transition-all ease-in-out duration-500">
                        <iframe class="w-full h-96" src="https://www.youtube.com/embed/__SIn1-nuUo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
            ...
            <div class="p-10">
                <div class="bg-white rounded-3xl p-5">
                    <div class="grid grid-cols-5">
                        <div class="flex p-3 rounded-3xl hover:bg-gray-100 transition-all ease-in-out duration-500">
                            <div class="w-1/3 flex">
                                <img class="h-20 w-20 rounded-full object-cover m-auto" src="{{asset('assets/stock_photo_rdev/JaneDoe.jpg')}}">
                            </div>
                            <div class="w-2/3 pl-3 flex">
                                <div class="m-auto">
                                    <span class="inline-block font-semibold">
                                        Jane Doe
                                    </span>
                                        <span class="inline-block text-xs font-light">Universitas Muhammadiyah Surakarta</span>
                                </div>
                            </div>
                        </div>
                        <div class="flex p-3 rounded-3xl hover:bg-gray-100 transition-all ease-in-out duration-500">
