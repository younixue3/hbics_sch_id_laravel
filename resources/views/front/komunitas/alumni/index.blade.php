            ...
            <div class="p-2 md:p-10">
                <div class="bg-white rounded-3xl p-1 md:p-5">
                    <div class="hidden md:grid grid-cols-5">
                        <div class="flex p-1 md:p-3 rounded-3xl hover:bg-gray-100 transition-all ease-in-out duration-500">
                            <div class="w-1/3 flex">
                                <img class="h-10 md:h-20 w-10 md:w-20 rounded-full object-cover m-auto" src="{{asset('assets/stock_photo_rdev/JaneDoe.jpg')}}">
                            </div>
