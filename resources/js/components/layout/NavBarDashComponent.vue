<template>
    <div id="mobile-menu"
         ...
         :class="collapsed ? 'w-60 md:w-80 lg:w-80' : 'w-0 md:w-11 lg:w-11 md:hover:w-60'">
        <div class="font-bold text-xl h-16 pr-2 md:pr-0 flex relative z-50">
            <img class="min-h-5 h-5 mx-3 my-auto" :class="collapsed ? '' : 'hidden'" src="" alt="">
            <div
                class="transition-all ease-in-out duration-500 my-auto text-2xl align-middle overflow-hidden truncate font-light"
                :class="collapsed ? 'w-full' : 'w-0'">
                RDeveloper
            </div>
