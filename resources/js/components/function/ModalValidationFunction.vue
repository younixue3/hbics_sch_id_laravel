<template>
    <Transition name="fade-rdev">
        <div v-if="$store.state.modalvalidation.status" class="fixed w-screen h-screen bg-black bg-opacity-25 backdrop-blur-sm flex z-50 transition-all ease-in-out duration-500" :class="$store.state.modalvalidation.status ? 'opacity-100' : 'opacity-0'">
