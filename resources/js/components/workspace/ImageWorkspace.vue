<template>
    <div class="relative">
        ...
        <img ref="previewimg" class="w-full object-cover rounded-3xl m-5" :class="inputMode === false || editmode !== 'false' ? 'h-96' : 'h-32 border border-black'" @dblclick="inputOn" :src="filename">
        <div v-if="editmode === 'false'" :class="inputMode ? '' : 'hidden'">
