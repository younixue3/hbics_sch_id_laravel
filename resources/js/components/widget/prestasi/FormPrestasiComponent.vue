<template>
    <div class="grid grid-cols-3 gap-5 text-left w-[42rem]">
        ...
        <div class="row-span-2">
            ...
            <img class="m-auto rounded-full h-24 w-24 object-cover border border-gray-200"
        ...
        <div class="col-start-1 col-span-2">
            ...
            <textarea disabled
                      ...
                      :value="$store.state.modal.modalshow.item.prestasi.detail_prestasi"></textarea>
        </div>
        <div class="col-start-1 col-span-2">
            <label class="block font-medium text-gray-700">
                Area
            ...
            <input disabled
                   ...
                   type="text" name="area" :value="$store.state.modal.modalshow.item.prestasi.area">
        </div>
    </div>
</template>
